        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">토론 댓글 관리 - 수정</h1>
                </div>

                <form id="debateComment-form">
                    <input type="hidden" name="id" value="${debateComment.id}" />
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                토론 댓글 내용</div>
                                            <input name="name" type="text" class="form-control" value="${debateComment.content}" aria-label="">
                                        </div>
                                        <div class="col-auto">
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <select name="document" class="form-select" aria-label="">
                                                <c:forEach var="document" items="${documents}">
                                                    <c:set var="selected" value="${document.id == debateComment.document.id ? 'selected' : ''}" />
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <select name="debate" class="form-select" aria-label="">
                                                <c:forEach var="debate" items="${debates}">
                                                    <c:set var="selected" value="${debate.id == debateComment.debate.id ? 'selected' : ''}" />
                                                    <option value="${debate.id}" ${selected}>
                                                            ${debate.name}
                                                    </option>
                                                </c:forEach>
                                            </select>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            수정</div>
                                        <a tabindex="0" onclick="patchRedirect('/admin/debateComment', 'debateComment-form', '/admin/debateComment')">
