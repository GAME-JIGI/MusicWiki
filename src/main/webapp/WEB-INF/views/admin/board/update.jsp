                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    게시판 이름</div>
                                                <input name="name" type="text" class="form-control" value="${board.name}" aria-label="">
                                            </div>
                                            <div class="col-auto">
                                            ...
                                            <div class="col mr-2">
                                                ...
                                                <select name="category" class="form-select" aria-label="">
                                                    <c:forEach var="category" items="${categories}">
                                                        <c:set var="selected" value="${category.id == board.category.id ? 'selected' : ''}" />
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                수정</div>
                                            <a tabindex="0" onclick="patchRedirect('/admin/board', 'board-form', '/admin/board')">
