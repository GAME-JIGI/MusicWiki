...
<jsp:useBean id="pagination" scope="request" type="com.gamejigi.wiki.util.PaginationResponse<com.gamejigi.wiki.domain.boardAnnounce.BoardAnnounce>"/>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">게시판 공지 관리</h1>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <a tabindex="0" onclick="fetchRedirect('/admin/boardannounce/test', 'post', '/admin/boardannounce')">
                            <button type="button" class="btn btn-primary">
                                테스트 데이터 생성하기
                            </button>
                        </a>
                        <a tabindex="0" onclick="fetchRedirect('/admin/boardannounce/test', 'delete', '/admin/boardannounce')">
                            <button type="button" class="btn btn-primary">
                                전체삭제하기
                            </button>
                        </a>
                        <a tabindex="0" href="/admin/boardannounce/create">
                            <button type="button" class="btn btn-primary">
                                생성
                            </button>
                        </a>
                                        ...
                                        <div class="dataTables_length">
                                            <label>
                                                ...
                                                <select name="length" id="board_size" class="custom-select custom-select-sm form-control form-control-sm"
                                                        onchange="moveParam('/admin/boardannounce', editParam('${parameter}', 'size', getValue('board_size')));">
                                        ...
                                        <div class="dataTables_filter">
                                            <label>
                                                ...
                                                <input type="search" id="board_search" class="form-control form-control-sm" placeholder=""
                                                       value="${param['search']}"
                                                       onchange="moveParam('/admin/boardannounce', editParam('${parameter}', 'search', getValue('board_search')))">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table table-bordered dataTable" width="100%"
                                            ...
                                            <tr role="row">
                                                <c:forEach var="col" items="${cols}" varStatus="status">
                                                    ...
                                                    <th id="board_column_${col}" class="sorting ${arrow_image}" tabindex="0"
                                                        onclick="moveParam('/admin/boardannounce', editParamSort('${parameter}', '${next_order}', '${col}'));">
                                                        ${content}
                                                    </th>
                                                </c:forEach>
                                                <th>상세 보기
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    <a tabindex="0" onclick="moveParam('/admin/boardannounce/detail', editParam('${parameter}', 'id', ${row.id}));">
                                                        <button type="button" class="btn btn-primary">
                                                            상세 보기
                                                        </button>
                                                    </a>
                                            ...
                                            <ul class="pagination" style="justify-content: center">
                                                <c:if test="${pagination.prevButton}">
                                                    <li class="paginate_button page-item previous">
                                                        <a onclick="moveParam('/admin/boardannounce', editParam('${parameter}', 'page', ${pagination.prevPage}));"
                                                ...
                                                <c:forEach var="page" items="${pagination.pageList}">
                                                    ...
                                                    <li class="paginate_button page-item ${active}">
                                                        <a onclick="moveParam('/admin/boardannounce', editParam('${parameter}', 'page', ${page}));"
                                                           tabindex="0" class="page-link">
                                                            ${page + 1}
                                                        </a>
                                                    </li>
                                                ...
                                                <c:if test="${pagination.nextButton}">
                                                    <li class="paginate_button page-item next">
                                                        <a onclick="moveParam('/admin/boardannounce', editParam('${parameter}', 'page', ${pagination.nextPage}));"
                                                           tabindex="0" class="page-link">
                                                            다음
                                                        </a>
                                                    </li>
