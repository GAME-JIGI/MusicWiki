...
<jsp:useBean id="pagination" scope="request" type="com.gamejigi.wiki.util.PaginationResponse<com.gamejigi.wiki.domain.debate.Debate>"/>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">토론 관리</h1>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <a tabindex="0" onclick="fetchRedirect('/admin/debate/test', 'post', '/admin/debate')">
                            <button type="button" class="btn btn-primary">
                                테스트 데이터 생성하기
                            </button>
                        </a>
                        <a tabindex="0" onclick="fetchRedirect('/admin/debate/test', 'delete', '/admin/debate')">
                            <button type="button" class="btn btn-primary">
                                전체삭제하기
                            </button>
                        </a>
                        <a tabindex="0" href="/admin/debate/create">
                            <button type="button" class="btn btn-primary">
                                생성
                            </button>
                        </a>
                                        ...
                                        <table class="table table-bordered dataTable" width="100%"
                                            ...
                                            <c:forEach var="row" items="${pagination.columnList}">
                                                <tr class="odd">
                                                    ...
                                                    <td>
                                                        <a tabindex="0" onclick="moveParam('/admin/debate/detail', editParam('${parameter}', 'id', ${row.id}));">
                                                            <button type="button" class="btn btn-primary">
                                                                상세 보기
                                                            </button>
                                                        </a>
                                            ...
                                            <ul class="pagination" style="justify-content: center">
                                                <c:if test="${pagination.prevButton}">
                                                    <li class="paginate_button page-item previous">
                                                        <a onclick="moveParam('/admin/debate', editParam('${parameter}', 'page', ${pagination.prevPage}));"
                                                ...
                                                <c:forEach var="page" items="${pagination.pageList}">
                                                    ...
                                                    <li class="paginate_button page-item ${active}">
                                                        <a onclick="moveParam('/admin/debate', editParam('${parameter}', 'page', ${page}));"
                                                           tabindex="0" class="page-link">
                                                                ${page + 1}
                                                        </a>
                                                    </li>
                                                ...
                                                <c:if test="${pagination.nextButton}">
                                                    <li class="paginate_button page-item next">
                                                        <a onclick="moveParam('/admin/debate', editParam('${parameter}', 'page', ${pagination.nextPage}));"
                                                           tabindex="0" class="page-link">
                                                            다음
                                                        </a>
                                                    </li>
