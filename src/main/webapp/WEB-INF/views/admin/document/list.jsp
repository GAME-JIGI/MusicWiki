    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">문서 관리</h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        -->
                        <a tabindex="0" href="/admin/document/create">
                            <button type="button" class="btn btn-primary">
                                생성
                            </button>
                        </a>
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table table-bordered dataTable" width="100%"
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1">문서 이름</th>
                                                <th rowspan="1" colspan="1">작성자 이름</th>
                                                <th rowspan="1" colspan="1">작성 일시</th>
                                            ...
                                            <c:forEach var="row" items="${pagination.columnList}">
                                                <tr class="odd">
                                                    ...
                                                    <td>
                                                        <a tabindex="0" href="/admin/document/detail?id=${row.id}">
                                                            <button type="button" class="btn btn-primary">
                                                                상세 보기
                                                            </button>
                                                        </a>
                                            ...
                                            <ul class="pagination" style="justify-content: center">
                                                <c:if test="${pagination.prevButton}">
                                                    <li class="paginate_button page-item previous">
                                                        <a onclick="movePage('/admin/document', ${pagination.prevPage}, '');"
                                                ...
                                                <c:forEach var="page" items="${pagination.pageList}">
                                                    ...
                                                    <li class="paginate_button page-item ${active}">
                                                        <a onclick="movePage('/admin/document', ${page}, '');" tabindex="0" class="page-link">
                                                                ${page + 1}
                                                        </a>
                                                    </li>
                                                </c:forEach>
                                                <c:if test="${pagination.nextButton}">
                                                    <li class="paginate_button page-item next">
                                                        <a onclick="movePage('/admin/document', ${pagination.nextPage}, '');"
                                                           tabindex="0" class="page-link">
                                                            다음
                                                        </a>
                                                    </li>
